...
def provision_directories(
    *,
    ...
    logging.info(f"Provisioning persistence queues directory ({deadline_persistence_queues_subdir})")
    os.makedirs(deadline_persistence_queues_subdir, exist_ok=True)
    logging.info(f"Done provisioning persistence queues directory ({deadline_persistence_queues_subdir})")
