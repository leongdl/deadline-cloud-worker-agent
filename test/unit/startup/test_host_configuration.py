...
def config_file_mock(mock_config_file_not_found):
    # Auto use mock_config_file_not_found for all tests.
    yield
...
class TestHostConfigurationScriptRunner:
    ...
    @pytest.mark.parametrize(
        ("script", "timeout", "success", "expected_logs", "test_os", "config_bootstrapped"),
        (
            pytest.param(
                None,
                300,
...
Get-ChildItem env: | ForEach-Object { "$($_.Name)=$($_.Value)" }
    ...
    def test_host_configuration_script_runner(
        ...
        runner = self._create_host_configuration_script_runner(
            ...
            config_bootstrapped=config_bootstrapped,
        )
    ...
    def test_script_file_access(self, queue_handler: QueueHandler, tmp_path: Path):
        ...
        if sys.platform != "win32":
            ...
            admin_group_sid, _, _ = win32security.LookupAccountName(None, getpass.getuser())
